...
export default function SarvagyaPage() {
  const articles = sarvagyaData;
      ...
      <section className="max-w-6xl mx-auto px-6 mb-16">
        <div className="text-center">
          <div className="inline-flex items-center gap-2 bg-orange-50 text-orange-700 px-4 py-2 rounded-full mb-4">
            ...
            <span className="text-sm font-bold uppercase tracking-wider">Sarvagya</span>
          </div>
          <h1 className="text-4xl md:text-6xl font-bold text-gray-900 mb-4">
            Knowledge & Wisdom
          </h1>
          <p className="text-xl text-gray-600 max-w-2xl mx-auto mb-8">
            Sharing knowledge and wisdom across disciplines.
          </p>
        </div>
      </section>
            ...
            return (
              <article key={article.id} className="group bg-white border border-gray-100 rounded-xl overflow-hidden hover:shadow-xl transition-all duration-300">
                ...
                <div className="p-6">
                  ...
                  {/* Title */}
                  <Link href={`/sarvagya/blog/${article.id}`}>
