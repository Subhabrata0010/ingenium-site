...
import abhayamanData from '../../data/abohoman/blogs.json';
...
export default function AbhayamanPage() {
  const articles = abhayamanData;
      ...
      <section className="max-w-6xl mx-auto px-6 mb-16">
        <div className="text-center">
          <div className="inline-flex items-center gap-2 bg-indigo-50 text-indigo-700 px-4 py-2 rounded-full mb-4">
            ...
            <span className="text-sm font-bold uppercase tracking-wider">Abohoman</span>
          </div>
          <h1 className="text-4xl md:text-6xl font-bold text-gray-900 mb-4">
            Campus Life & Culture
          </h1>
          <p className="text-xl text-gray-600 max-w-2xl mx-auto">
            Stories, events, and perspectives from the heart of our campus community.
          </p>
        </div>
      </section>
      ...
      <section className="max-w-6xl mx-auto px-6">
              ...
              <article key={article.id} className="group bg-white border border-gray-100 rounded-xl overflow-hidden hover:shadow-xl transition-all duration-300">
                ...
                <div className="relative w-full aspect-video bg-gray-100 overflow-hidden">
                  <div className="absolute top-3 left-3 z-10">
                    <span className="bg-indigo-600 text-white text-xs font-bold uppercase px-3 py-1.5 tracking-wider rounded">
                      {article.department}
                    </span>
                  </div>
                  {coverId && (
                ...
                <div className="p-6">
                  ...
                  {/* Title */}
                  <Link href={`/abohoman/blog/${article.id}`}>
        ...
        {articles.length === 0 && (
          <div className="text-center py-20">
            ...
            <p className="text-gray-600">Check back soon for campus stories!</p>
          </div>
        )}
      </section>
    </main>
