    ...
    <main className="min-h-screen bg-white pt-24 pb-16">
      ...
      <section className="max-w-6xl mx-auto px-6 mb-16">
        <div className="text-center">
          <div className="inline-flex items-center gap-2 bg-rose-50 text-rose-700 px-4 py-2 rounded-full mb-4">
              ...
              <article key={article.id} className="group bg-white border border-gray-100 rounded-xl overflow-hidden hover:shadow-xl transition-all duration-300">
                ...
                <div className="relative w-full aspect-video bg-gray-100 overflow-hidden">
                  <div className="absolute top-3 left-3 z-10">
                    <span className="bg-rose-600 text-white text-xs font-bold uppercase px-3 py-1.5 tracking-wider rounded">
                      {article.department}
                    </span>
                  </div>
                  {coverId && (
                ...
                <div className="p-6">
                  ...
                  {/* Title */}
                  <Link href={`/archive/blog/${article.id}`}>
